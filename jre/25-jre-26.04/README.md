...
We currently have Chiselled OpenJDK 25 on Resolute. See
...
$ rockcraft.skopeo copy \
 oci-archive:jre_25-edge_amd64.rock \
 docker-daemon:ubuntu/jre:25_edge
```
...
```sh
$ docker run --rm ubuntu/jre:25_edge exec java
...
The example is available [here](../../demos/25-jre-26.04/helloworld/).

### Spring Petclinic

An advanced example of deploying a Spring Boot application
is available [here](../../demos/25-jre-26.04/petclinic/).
